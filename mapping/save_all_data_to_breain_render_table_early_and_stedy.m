...
% A map showing the (14) cells that are transient light-responsive, (15) cells that are sustained  light-responsive, (13) cells that are both transient and sustained  light-responsive, and (16) all recorded cells.
% A map showing the (11) cells that are transient intensity-encoding, (12)
% cells that are sustained intensity-encoding, (10) cells that are both transient and sustained intensity-encoding.
clc
clear
